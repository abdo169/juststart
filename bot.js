...
if (message.content.startsWith('.bcall')){
 if (message.author.id !== '339863048611168256') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
 if(!message.author.id === '339863048611168256') return;
